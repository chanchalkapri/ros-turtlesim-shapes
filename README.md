...
This repository contains a **ROS (Robot Operating System)** project using **turtlesim**, where turtle motion is controlled to draw basic geometric shapes by publishing velocity commands.

The project includes a **demo video** showing the execution of `turtlesim_node` and shape drawing.
...
## 🎯 Project Highlights
- Launching and working with `turtlesim_node`
- Publishing velocity commands on `/cmd_vel`
- Understanding linear & angular motion
- Robotics motion control fundamentals
- Visual simulation using turtlesim

---

## 🎥 Demo
A video is included demonstrating:
- Opening the turtlesim node
- Drawing multiple geometric shapes
...
## 🚀 Future Enhancements
- Add circle and spiral patterns
...
## 📬 Author
**Chanchal Kapri**  
B.Tech CSE (AI) | Robotics & AI Enthusiast
